...
require_once(_DIR_ . "/APIv3-php-library/autoload.php");
# Instantiate the client\
SendinBlue\Client\Configuration::getDefaultConfiguration()->setApiKey("api-key", "KAIU4Sb1CfDyFMcm");
...
$email_campaigns['sender'] = array("name": "From name", "email":"masivos@grupolahe.com");
