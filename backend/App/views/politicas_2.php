                            ...
                            <div class="card-body pt-1">
                                <form class="form-horizontal" id="pass_form" action="/Register/DataPassword" method="POST">
                                    ...
                                    <div class="text-center">
                                        ...
                                        Términos y Condiciones de Uso de plataforma Protocolo de seguridad en Convención Asofarma 2022.
                                        </span>
                                    </div>
                                    <br>
...
<script>
    ...
    $(document).ready(function(){
        $('#terminos').scroll(function() {
            if ($('#terminos').scrollTop()+352 > $('#terminos div').height()) {
