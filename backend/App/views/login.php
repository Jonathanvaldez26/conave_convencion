                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n9">
                                ...
                                <video autoplay muted loop >
                                    <source class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" src="/assets/img/curved-images/curvedbg3.mp4" type="video/mp4">
                                </video>
                            </div>
                        </div>
                    </div>
