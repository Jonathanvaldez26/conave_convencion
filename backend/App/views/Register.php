                                                                ...
                                                                <div class="multisteps-form__content">
                                                                    <div class="row mt-3">
                                                                        <div class="col-12 col-sm-6">
                                                                            ...
                                                                            <input class="multisteps-form__input form-control" type="email" placeholder="usuario@grupolahe.com" onfocus="focused(this)" onfocusout="defocused(this)">
                                                                        </div>
                                                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                                            <label>Confirma tu Email:</label>
                                                                            <input class="multisteps-form__input form-control" type="text" placeholder="usuario@grupolahe.com" onfocus="focused(this)" onfocusout="defocused(this)">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="card-body pt-0">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-4 col-6">
                                                                                <div>
                                                                                    ...
                                                                                    <select class="form-control" style="cursor: pointer;" aria-expanded="false" name="choices-button" id="choices-button" placeholder="Genero" >
                                                                                        <option value="Male" id="choices--choices-gender-item-choice-1" class="choices__item choices__item--choice choices__item--selectable is-highlighted" role="option" data-choice="" data-id="1" data-value="Female" data-select-text="Press to select" data-choice-selectable="" aria-selected="true">Hombre</option>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-3 col-3">
                                                                                        ...
                                                                                        <select class="form-control" style="cursor: pointer;" name="choices-day" id="choices-day" tabindex="-1" data-choice="active">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6 align-self-center">
                                                                                ...
                                                                                <select style="cursor: pointer;" class="form-control" name="choices-linea" id="choices-linea" tabindex="-1" data-choice="active">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <!-- NO BORRAR PARA FUTURAS REFERENCIAS DE ESTILO <div class="choices" data-type="text" aria-haspopup="true" aria-expanded="false">
