...
sql;
    ...
    public static function insert($data){
        ...
        $query=<<<sql
        INSERT INTO comprobante_vacuna (id_comprobante_vacuna, utilerias_asistentes_id, fecha_carga_documento, numero_dosis, marca_dosis, documento, status, validado) VALUES ('',:utilerias_asistentes_id, NULL, :numero_dosis, :marca_dosis, :documento, 1,0);
sql;
        $parametros = array(
